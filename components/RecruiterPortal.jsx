...
import { JourneyStage, CandidateCategory, PricingTier } from '../datastore.js';
            ...
            <div className="bg-white rounded-[3rem] shadow-3xl border border-slate-100 overflow-hidden animate-fade-in">
                <div className="p-12 border-b border-slate-50 flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-[10px] font-bold tracking-tight text-slate-400 mt-1">Shared repository of all elevAIte pro candidates</p>
                    </div>
